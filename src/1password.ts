...
import type { Client } from "npm:@1password/sdk";
...
export async function configure(token : string, accountName : string, version : string) {
...
const getSecret = async (vault : string, name : string, field : string) => {
...
export const getSecrets = (vault : string, name : string, ...fields : string[]) => {
